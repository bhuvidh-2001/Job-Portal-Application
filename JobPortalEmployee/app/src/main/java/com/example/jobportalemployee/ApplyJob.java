            ...
            public void onClick(View v) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (qual.equalsIgnoreCase(requal) && exp.equalsIgnoreCase(reqexp)) {
                                ...
                                Toast.makeText(com.example.jobportalemployee.ApplyJob.this, "Job Applied", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(com.example.jobportalemployee.ApplyJob.this, "Not Eligible For This Job", Toast.LENGTH_SHORT).show();
                            }
