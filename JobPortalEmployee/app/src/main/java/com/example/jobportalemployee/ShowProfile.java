    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(com.example.jobportalemployee.ShowProfile.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        downloadcv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        try{
                            String cv=dataSnapshot.child("cv").child("url").getValue().toString();
