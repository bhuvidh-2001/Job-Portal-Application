...
FirebaseAuth mAuth;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        checkRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (name==null){
                    Intent intent=new Intent(com.example.jobportalemployee.ProfileActivity.this,EditProfile.class);
        ...
        RecyclerView.LayoutManager manager = new LinearLayoutManager(com.example.jobportalemployee.ProfileActivity.this);
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            myRef.addChildEventListener(new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    String company_name = dataSnapshot.child("name").getValue(String.class);
                    ...
                    String jobdescription = dataSnapshot.child("jobdescription").getValue(String.class);
                    String jobqualification = dataSnapshot.child("jobqualification").getValue(String.class);
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(com.example.jobportalemployee.ProfileActivity.this, "Error", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (s.isEmpty()) {
                    Toast.makeText(com.example.jobportalemployee.ProfileActivity.this, "No Result", Toast.LENGTH_SHORT).show();
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                            ...
                            Intent intent=new Intent(com.example.jobportalemployee.ProfileActivity.this, com.example.jobportalemployee.ApplyJob.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_edit) {
            ...
            startActivity(new Intent(com.example.jobportalemployee.ProfileActivity.this,AppliedJob.class));
        }
