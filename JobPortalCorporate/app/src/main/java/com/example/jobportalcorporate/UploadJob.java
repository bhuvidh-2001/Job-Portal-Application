       ...
       ImageView date=(ImageView)findViewById(R.id.date);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(com.example.jobportalcorporate.UploadJob.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.example.jobportalcorporate.PostJob pj=new com.example.jobportalcorporate.PostJob(name,jobid,location,jobdescription,experience,jobqualification,skills,salary,contact,emailid,jobtype,date,uid);
                ...
                try {
                    ...
                    Toast.makeText(com.example.jobportalcorporate.UploadJob.this, "Error", Toast.LENGTH_SHORT).show();
                }

                Toast.makeText(com.example.jobportalcorporate.UploadJob.this, "Job Posted", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(com.example.jobportalcorporate.UploadJob.this,ProfileActivity.class);
